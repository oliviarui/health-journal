            ...
            <div className="register-container">
                ...
                <div className="user-pass">
                    ...
                    <br />
                        ...
                        <input type="button" className="register" value="register" onClick={this.submitForm} />
                        </div>
                        <div id="error-register"><br  /></div>
                        <div className="form-group">
                            <h2>
                            have an account? <br />
                            </h2>
                            <a href="/login">
                            <input type="button" class="register" value="back to login" />
                            </a>
                        </div>
                    </form>
                </div>
